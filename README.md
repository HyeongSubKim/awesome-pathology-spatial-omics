...
- [🖼️➡️🧬 Histology → Gene Expression Prediction](#histology-to-gene-expression) (20)
...
| [DeepSpot2Cell: Predicting Virtual Single-Cell Spatial Transcriptomics from H&E images using Spot-Level Supervision](https://openreview.net/forum?id=ofCkwXQKaz) | NeurIPS | 2025 | spatial transcriptomics, H2ST, sc RNA-seq | [[paper]](https://openreview.net/forum?id=ofCkwXQKaz) [![code](https://img.shields.io/badge/code-black?logo=github)](https://github.com/ratschlab/DeepSpot2Cell) |
...
| [Representation learning for multi-modal spatially resolved transcriptomics data](https://academic.oup.com/bioinformatics/advance-article/doi/10.1093/bioinformatics/btag316/8692433) | Bioinformatics | 2026 | spatial transcriptomics | [[paper]](https://academic.oup.com/bioinformatics/advance-article/doi/10.1093/bioinformatics/btag316/8692433) [![code](https://img.shields.io/badge/code-black?logo=github)](https://github.com/ratschlab/aestetik) |
