...
| GSAT-RAG: Open-Set Spatial Gene Expression Prediction from Histological Images via Retrieval-Augmented Generation | CVPR | 2026 | spatial transcriptomics, H2ST, sc RNA-seq | — |
